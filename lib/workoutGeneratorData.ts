...
export const exerciseLibrary: Exercise[] = [
  ...
  },
  {
    ...
    workoutTags: ["push", "upper", "full_body", "beginner_friendly", "female_friendly", "bodybuilding"],
  ...
  },
  {
    ...
    equipmentAccess: ["full_gym", "machines_only"],
    levels: ["beginner", "intermediate", "advanced"],
    workoutTags: ["pull", "upper", "full_body", "beginner_friendly", "female_friendly", "bodybuilding"],
    styleTags: ["balanced", "bodybuilding", "high_volume", "pump"],
    laterality: "bilateral",
    fatigueCost: 2,
    complexity: 1,
  ...
  },
  {
    ...
    equipmentAccess: ["full_gym", "machines_only"],
    levels: ["beginner", "intermediate", "advanced"],
    workoutTags: ["lower", "full_body", "beginner_friendly", "female_friendly", "bodybuilding"],
  ...
  },
  {
    ...
    equipmentAccess: ["full_gym", "machines_only"],
    levels: ["beginner", "intermediate", "advanced"],
    workoutTags: ["lower", "beginner_friendly", "female_friendly", "glute_friendly", "bodybuilding"],
    styleTags: ["bodybuilding", "high_volume", "pump"],
    laterality: "bilateral",
    fatigueCost: 1,
    complexity: 1,
  ...
  },
  {
    ...
    equipmentAccess: ["full_gym", "dumbbells_only", "minimal_home_gym"],
    levels: ["beginner", "intermediate", "advanced"],
    workoutTags: ["push", "upper", "full_body", "female_friendly", "beginner_friendly", "bodybuilding"],
  ...
  },
  {
    ...
    levels: ["beginner", "intermediate", "advanced"],
    workoutTags: ["pull", "upper", "full_body", "female_friendly", "beginner_friendly", "bodybuilding"],
    styleTags: ["bodybuilding", "pump", "high_volume"],
    laterality: "bilateral",
    fatigueCost: 1,
    complexity: 1,
  ...
  },
  {
    ...
    equipmentAccess: ["full_gym"],
    levels: ["beginner", "intermediate", "advanced"],
    workoutTags: ["push", "upper", "beginner_friendly", "female_friendly", "bodybuilding"],
    styleTags: ["balanced", "bodybuilding", "pump", "high_volume"],
    laterality: "bilateral",
    fatigueCost: 1,
    complexity: 1,
