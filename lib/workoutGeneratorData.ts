...
export const exerciseLibrary: Exercise[] = [
...

  {
    ...
    levels: ["beginner", "intermediate", "advanced"],
    workoutTags: ["lower", "full_body", "glute_friendly", "bodybuilding", "female_friendly"],
  ...
  },
  {
    ...
    equipmentAccess: ["full_gym", "dumbbells_only", "minimal_home_gym", "bodyweight_only", "barbell_rack"],
    levels: ["beginner", "intermediate", "advanced"],
